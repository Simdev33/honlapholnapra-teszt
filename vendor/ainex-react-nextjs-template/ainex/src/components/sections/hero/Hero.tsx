...
const Hero = () => {
	const handleHeroLinkClick = (href: string) => (event: MouseEvent<HTMLAnchorElement>) => {
		if (!href.startsWith("#")) {
			return;
		}
			...
			<div className="hh-hero-shell">
				<div className="hh-hero-copy wow fadeInUp" data-wow-delay=".2s">
					...
					<div className="hh-hero-actions">
						<Link href="#kapcsolat" onClick={handleHeroLinkClick("#kapcsolat")} className="tj-primary-btn">
						...
						<Link href="#kapcsolat" onClick={handleHeroLinkClick("#kapcsolat")} className="hh-hero-secondary">
							Hogyan működik?
						</Link>
					</div>
