...
export function CookieConsent() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "pointer-events-auto w-full max-w-2xl rounded-2xl border border-white/20",
      ...
      >
        ...
        <div className="relative z-10 flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:gap-6 sm:p-6">
          <div className="flex shrink-0 justify-center sm:justify-start">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-cyan-500 shadow-[0_12px_32px_rgba(124,58,237,0.35)]">
              <Cookie className="h-6 w-6 text-white" aria-hidden />
            </div>
          </div>
          ...
          <div className="flex shrink-0 flex-col gap-2 sm:w-auto sm:min-w-[200px]">
            <button
              type="button"
              onClick={() => save("all")}
              className="rounded-xl px-4 py-2.5 text-sm font-semibold text-white gradient-purple shadow-[0_8px_24px_rgba(124,58,237,0.35)] transition-opacity hover:opacity-90"
            >
              Összes elfogadása
            </button>
            <button
