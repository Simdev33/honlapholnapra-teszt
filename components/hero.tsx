...
export function Hero() {
  return (
    <section className="relative isolate flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 z-[1] bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(255,255,255,0.42)_72%,rgba(248,250,252,0.9)_100%)]" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pt-32 pb-20 text-center">
        <div className="glass mb-8 inline-flex items-center gap-2 rounded-full px-4 py-2 animate-fade-in">
          ...
          <span className="relative z-10 text-sm text-slate-700">Weboldal akár 24 óra alatt</span>
        </div>

        <h1 className="mb-8 text-5xl font-bold tracking-tight leading-[1.05] text-slate-900 sm:text-6xl md:text-7xl lg:text-8xl">
          Szó szerint értjük:
          <br />
          <span className="text-blue-700">Honlap. Holnapra.</span>
        </h1>
        ...
        <div className="mb-16 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          >
            <span className="relative z-10">Kérek egy azonnali ajánlatot!</span>
        ...
        <div className="glass glass-panel mx-auto max-w-5xl rounded-[2rem] border border-blue-200/80 bg-gradient-to-b from-slate-100/80 to-white/90 p-4 shadow-[0_18px_44px_rgba(15,42,74,0.16)] sm:p-6">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={stat.label} className="glass-panel rounded-2xl border border-blue-100 bg-gradient-to-b from-white to-slate-50 p-6 text-center shadow-[0_12px_26px_rgba(15,42,74,0.12)]">
                <div className="relative z-10 mb-2 text-3xl font-bold text-slate-900 sm:text-4xl">{stat.value}</div>
                <div className="relative z-10 text-sm text-slate-600">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 z-20 -translate-x-1/2">
        <div className="flex h-10 w-6 items-start justify-center rounded-full border border-blue-300 bg-white/85 p-2 shadow-[0_8px_20px_rgba(15,42,74,0.12)]">
          <div className="h-2 w-1 animate-bounce rounded-full bg-blue-700" />
        </div>
      </div>
    </section>
  )
